...
const AboutPage = () => (
  <Layout>
    ...
    <Grid.Row style={{ marginTop: `1em`, display: 'flex', flexDirection: 'column' }}>
      ...
      <p>Board Explorer data was collected and checked by Nicole Brambila, Emma Folts, Jourdan Hicks, TyLisa Johnson, Veonna King, Rich Lord, Oliver Morrison, Jon Moss, Mitra Nourbakhsh and Juliette Rihl.</p>
